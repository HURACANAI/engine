...
def get_top_coins_from_binance(top_n: int = 10, min_volume_usdt: float = 1_000_000) -> List[str]:
    ...
    try:
        ...
        for symbol in usdt_pairs:
            if symbol in tickers:
                ...
                base = symbol.split('/')[0]
                if base in ['USDT', 'BUSD', 'USDC', 'TUSD', 'USDD', 'DAI', 'FDUSD']:
                    continue
        ...
        print("   Using default top 10 coins...")
...
def main():
    ...
    parser.add_argument("--top", type=int, default=10, help="Number of top coins to train (default: 10)")
